...
client = Bot(description="Rayven Ikon", command_prefix="@", pm_help = False)
...
async def on_ready():
	...
	return await client.change_presence(game=discord.Game(name="with Aouab's dick")) #This is buggy, let us know if it doesn't work.
...
client.run('NDM1NTc2NTIwMTkxMjQ2MzM4.DbeWrA.vtWuc_ukaNEzsTmMXUzDLnFgnwA')
