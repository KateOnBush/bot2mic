...
var answersyesorno = ["yup","nopeeeee","no lol","no lmao","nop","yay","ofc","Of course","no","i guess so","i don't think so","That's obviously true... what did you think?","Yeah!","No , at all!","nope.","Of course... not.","Absolutely!","Probably not!","I think so.","Yeah , I believe.","That's a yes.","Yes.","No , no , no and no!","I have no fucking idea.","I don't know.","WTF? Ask google not me","Do you think im stupid? that's yes.","I don't wanna answer.","Ummm... yeah."];
...
var responses = ["Good","Fine","Okay then.","Okay","K.","Really?","Ok.","lol.","lmao","hahahah","for real?","hmmm..","xD.","<:Moooore:427561997605928973>","<:huh:427562025229484033>","<:evilpatrick:427562269195632658>"]
var nothing = ["Can u repeat ? I didn't hear you.","You didn't say anything '-'","U didn't say anything.","what are u saying <:huh:427562025229484033>","lol i can't reply to nothing xD","<:evilpatrick:427562269195632658><:evilpatrick:427562269195632658><:evilpatrick:427562269195632658> say smtg wtf","are u seriously expecting me to reply to nothing?","<:Bullshit:427561941230419988> stop writing nothing."]
...
client.on('message', message => {
	...
	if(message.channel != message.guild.channels.find("name","talk-to-the-human")) return;
		if((sf === "q") || (sf == null) || (sf === "")){
			...
			} else if ((sf.includes("how much")) || (sf.includes("how many"))){
